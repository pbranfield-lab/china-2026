...
const TRIP_FORBIDDEN_CITY = {
  ...
  facts: [
    { stat:"980", label:"buildings",
      q:"How many separate buildings are inside the Forbidden City?",
    ...
    { stat:"8,707", label:"rooms",
      q:"How many rooms has the Forbidden City got?",
    ...
    { stat:"1,000,000", label:"workers",
      q:"How many workers did it reportedly take to build it?",
    ...
    { stat:"0", label:"nails",
      q:"How many nails are holding the big wooden halls together?",
    ...
    { stat:"492", label:"years of emperors",
      q:"How many years did emperors live at this one address?",
    ...
    { stat:"10", label:"roof animals",
      q:"How many little animal statues sit on the fanciest roof in the palace?",
    ...
    { stat:"308", label:"fire vats",
      q:"How many giant fire-fighting water vats are parked around the palace?",
    ...
    { stat:"0", label:"trees in the big courtyards",
      q:"How many trees grow in the big main courtyards?",
    ...
    { stat:"52 m", label:"of moat",
      q:"How wide is the moat that goes round the palace walls?",
    ...
    { stat:"19 million", label:"visitors a year",
      q:"How many people visit the Forbidden City every year?",
