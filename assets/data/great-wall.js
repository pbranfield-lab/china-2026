...
const TRIP_GREAT_WALL = {
  ...
  facts: [
    { stat:"21,196", label:"km of wall in total",
      q:"How many kilometres of Great Wall are there in total, counting every separate bit?",
    ...
    { stat:"3.8x", label:"London to New York",
      q:"How long is all the Great Wall put together, compared to the distance from London to New York?",
    ...
    { stat:"0", label:"who've seen it from space, naked eye",
      q:"How many people have actually seen the Great Wall from space with their naked eye?",
    ...
    { stat:"8,851.8", label:"km of Ming wall alone",
      q:"How many kilometres of the wall did the Ming dynasty build on their own?",
    ...
    { stat:"23", label:"watchtowers at Mutianyu",
      q:"How many watchtowers are on the Mutianyu stretch we walked?",
    ...
    { stat:"1368", label:"when the Ming rebuilt it",
      q:"What year did the Ming start rebuilding the wall at Mutianyu?",
    ...
    { stat:"1,580 m", label:"of toboggan",
      q:"How long is the toboggan ride back down the mountain?",
