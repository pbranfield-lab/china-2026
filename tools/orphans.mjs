...
const { TRIPS, PHOTOS, FAMILY, AUDIO, THEN_NOW } =
  new Function(src + ";return {TRIPS,PHOTOS,FAMILY,AUDIO,THEN_NOW};")();
...
for (const p of (THEN_NOW || {}).pairs || []) used.add(`Photographs/${p.then.file}`.toLowerCase());
