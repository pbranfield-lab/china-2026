...
**Last updated: 2026-08-09 03:52.** Read this, then `CLAUDE.md` for the
architecture detail.
...
- **Done:** Task 1 only — `tools/check.mjs`, a structural check harness.
  ...
  regression.
- **Next:** Task 2 — the palette and typography swap.
- Execute with `superpowers:executing-plans` (or subagent-driven). Read the plan;
  do not re-derive the design.

Everything below this line describes the state **before** the re-skin started and
is still accurate about how the site works today.
