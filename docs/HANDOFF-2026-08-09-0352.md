...
**State: everything is done, verified, committed, pushed and live.** Working tree
clean, `master` in sync with `origin/master`, site up. There is nothing
half-finished to pick up — the next session starts fresh. Jump to **"Picking it
